...
let vegtable1 = document.getElementById("veggie1").value;
let vegtable2 = document.getElementById("veggie2").value;
...
veg1.innerHTML = vegtable1;
veg2.innerHTML = vegtable2;
